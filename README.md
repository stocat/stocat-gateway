...
- 추출 규칙: `memberId` 클레임이 있으면 사용, 없으면 `sub`(subject)를 사용합니다. 둘 다 없거나 인증이 없으면 빈 문자열을 전달합니다.
- 전달 헤더: `X-Member-Id`
- 구현: `gateway/src/main/java/com/stocat/gateway/filter/MemberIdHeaderFilter.java`
